                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <textarea v-model="userData.message" id="message" rows="3" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <label>
                                    <input v-model="userData.gender" type="radio" value="Kadın"> Kadın
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 from-group">
                                ...
                                <select v-model="userData.selectedCity" class="form-control">
                                    <option :selected="city == 'Adana'" v-for="city in userData.cities" :key="city.id">{{ city }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
    ...
    data() {
        return {
            userData: {
                ...
                interests: [],
                gender: '',
                cities: ['Adana', 'Ankara', 'İstanbul', 'İzmir', 'Bursa', 'Trabzon'],
                selectedCity: ''
            },
            switched: true,
            isSubmitted : false
